...
def get_CE(cal_df):
    ...
    cal_df["CE"] = ((cal_df["NO2_t_mean"]-cal_df["NO_t"])-(cal_df["NO2_u_mean"]-cal_df["NO_u"])) / (cal_df["NO_u"]-cal_df["NO_t"])
...
if __name__ == "__main__":
    ...
    output_folder = os.path.join(curr_folder,"processed_data/sens_ce")
    #years = [2022]
